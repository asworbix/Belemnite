...
export function renderPoisonPage(options) {
...
<main>
${sections
        .map((text, i) => `<section><h2>${escapeText(sectionHeading(topic, i))}</h2><p>${escapeText(text)}</p></section>`)
        .join('\n')}
</main>
<footer>
...
function sectionHeading(topic, index) {
